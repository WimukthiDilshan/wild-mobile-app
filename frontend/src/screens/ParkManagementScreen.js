...
const ParkManagementScreen = ({ navigation }) => {
  ...
  const parkCategories = ['National Park', 'Nature Reserve', 'Wildlife Sanctuary', 'Forest Reserve', 'Marine Park'];
        ...
        {parks.map((park, index) => (
          <View key={park.id || index} style={styles.parkCard}>
            ...
            <View style={styles.parkDetails}>
              ...
              {park.established && (
                <Text style={styles.detailText}>📅 Est: {park.established}</Text>
              )}
              {park.description && (
                <Text style={styles.descriptionText}>{park.description}</Text>
              )}
              {park.facilities && (
                <Text style={styles.detailText}>🏪 Facilities: {park.facilities}</Text>
              )}
            </View>
